    ...
    <section className="relative bg-pink-50 py-15 lg:py-22 overflow-hidden">
      <div className="relative max-w-6xl mx-auto px-4">
        ...
        <div className="relative rounded-3xl overflow-hidden">
          <Image
            src="/logos/heroann.jpg" // 🔸replace with your actual image path
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-white px-4">
            ...
            >
              Get the latest updates on our programs, events, and community initiatives—so you never miss a chance to make an impact.
            </motion.p>
          </div>
        </div>
      </div>
